...
<title>{{trans('lang.swiggiweb_message')}}</title>
...
<link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600;700&family=Montserrat:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
</head>
...
<div class="filter">
<h6 class="px-3 py-3 bg-light pb-1 m-0 border-bottom">{{trans('lang.choose_country')}}</h6>
...
<p class="m-0">{{trans('lang.account_credits')}}</p>
...
<div class="left mr-3">
<h6 class="font-weight-bold mb-1 text-dark">{{trans('lang.address')}}</h6>
...
<div class="left mr-3">
<h6 class="font-weight-bold m-0 text-dark"><i class="feather-truck bg-danger text-white p-2 rounded-circle mr-2"></i>{{trans('lang.delivery_support')}}</h6>
</div>
<div class="right ml-auto">
<h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
</div>
...
<div class="ml-3">
<h6 class="text-dark mb-2 mt-0">{{trans('lang.help_forum')}}</h6>
<p class="mb-0 text-muted">{{trans('lang.find_ans_to_que_from_basics')}}
</p>
</div>
</div>
<div class="overflow-hidden border-top d-flex align-items-center p-3">
<a class="font-weight-bold d-block" href="#"> {{trans('lang.swiggiweb_help_forum')}} </a>
...
<p class="mb-0 text-muted">{{trans('lang.want_to_learn_about_setting_up_managing')}}
</p>
</div>
</div>
<div class="overflow-hidden border-top d-flex align-items-center p-3">
<a class="font-weight-bold d-block" href="#"> Swiggiweb {{trans('lang.safety_center')}}. </a>
<i class="feather-arrow-right-circle ml-auto text-primary"></i>
</div>
</div>
<div id="basics">
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn p-3 collapsed" data-toggle="collapse" data-target="#basicsCollapseOne" aria-expanded="false" aria-controls="basicsCollapseOne">
 {{trans('lang.do_you_have_built_in_caching')}}
...
<div class="card-body border-top p-3 text-muted">
 {{trans('lang.anim_pariatur_cliche_message')}}
</div>
</div>
</div>
<div class="box border-bottom bg-white mb-2 rounded shadow-sm overflow-hidden">
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn p-3 collapsed" data-toggle="collapse" data-target="#basicsCollapseTwo" aria-expanded="false" aria-controls="basicsCollapseTwo">
 {{trans('lang.can_add_upgrade_plan')}}
<span class="card-btn-arrow">
<span class="feather-chevron-down"></span>
</span>
</button>
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn p-3 collapsed" data-toggle="collapse" data-target="#basicsCollapseThree" aria-expanded="false" aria-controls="basicsCollapseThree">
 {{trans('lang.what_access_comes_with_hosting_plan')}}
<span class="card-btn-arrow">
<span class="feather-chevron-down"></span>
</span>
</button>
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn collapsed p-3" data-toggle="collapse" data-target="#basicsCollapseFour" aria-expanded="false" aria-controls="basicsCollapseFour">
 {{trans('lang.how_can_change_password')}}
<span class="card-btn-arrow">
<span class="feather-chevron-down"></span>
</span>
</button>
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn collapsed p-3" data-toggle="collapse" data-target="#accountCollapseTwo" aria-expanded="false" aria-controls="accountCollapseTwo">
 {{trans('lang.how_delete_my_account')}}
<span class="card-btn-arrow">
<span class="feather-chevron-down"></span>
</span>
</button>
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn collapsed p-3" data-toggle="collapse" data-target="#accountCollapseThree" aria-expanded="false" aria-controls="accountCollapseThree">
 {{trans('lang.how_change_my_account_setting')}}
<span class="card-btn-arrow">
<span class="feather-chevron-down"></span>
</span>
</button>
...
<button class="shadow-none btn btn-block d-flex justify-content-between card-btn collapsed p-3" data-toggle="collapse" data-target="#accountCollapseFour" aria-expanded="false" aria-controls="accountCollapseFour">
 {{trans('lang.forgot_my_password_how_reset')}}
<span class="card-btn-arrow">
<span class="feather-chevron-down"></span>
</span>
</button>
...
<ul class="list-unstyled hov_footer">
<li> <a href="login.html" class="text-muted"> {{trans('lang.user_login')}} </a></li>
<li> <a href="signup.html" class="text-muted"> {{trans('lang.user_register')}} </a></li>
...
<li> <a href="restaurant.html" class="text-muted"> {{trans('lang.restaurant_details')}} </a></li>
...
<li><a href="restaurant.html"><i class="feather-paperclip mr-2"></i> {{trans('lang.restaurant_details')}}</a></li>
...
<li>
<a href="#"><i class="feather-user mr-2"></i> {{trans('lang.profile')}}</a>
<ul>
<li><a href="profile.html">{{trans('lang.profile')}}</a></li>
...
<div class="col-md-12 form-group"><label class="form-label">{{trans('lang.delivery_instruction')}}</label><input placeholder="Delivery Instructions e.g. Opposite Gold Souk Mall" type="text" class="form-control"></div>
<div class="mb-0 col-md-12 form-group">
<label class="form-label">{{trans('lang.nickname')}}</label>
