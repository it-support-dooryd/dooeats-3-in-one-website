...
<script type="text/javascript">
    ...
    async function getCurrentDeliveryLocation() {
        // Geolocation functionality disabled - location is now optional
        // Users can manually enter their address
        console.log('Location functionality has been disabled. Please enter your address manually.');
    }
    // showErrorOSM, showPositionOSM, and fetchNearbyPlacesOSM functions removed - geolocation disabled
